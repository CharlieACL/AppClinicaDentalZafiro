...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3C4474);
  late Color secondary = const Color(0xFF2474BC);
  late Color tertiary = const Color(0xFFD49C0D);
  late Color alternate = const Color(0xFFCFDCE3);
