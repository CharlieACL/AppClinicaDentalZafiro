...
export 'inventory_create_model.dart';

class InventoryCreateWidget extends StatefulWidget {
  const InventoryCreateWidget({super.key});

  @override
  State<InventoryCreateWidget> createState() => _InventoryCreateWidgetState();
}

class _InventoryCreateWidgetState extends State<InventoryCreateWidget> {
  late InventoryCreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InventoryCreateModel());
            ...
            children: [
              ...
              Opacity(
                ...
                child: Padding(
                  ...
                  child: Container(
                    width: MediaQuery.sizeOf(context).width * 1.0,
                    height: MediaQuery.sizeOf(context).height * 0.613,
                    decoration: BoxDecoration(
                      color: FlutterFlowTheme.of(context).secondaryBackground,
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          'Digite el nombre del suministro',
                          ...
                          child: Row(
                            ...
                            children: [
                              FlutterFlowDropDown<String>(
                                controller:
                                    _model.comboCategoryValueController ??=
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          'Digite la descripción del suministro',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily: 'Readex Pro',
                              ...
                              Expanded(
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      8.0, 0.0, 8.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.txtAmountTextController,
                                    focusNode: _model.txtAmountFocusNode,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText:
                                          'Digite la cantidad del suministro',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily: 'Readex Pro',
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          'Digite el precio del suministro',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily: 'Readex Pro',
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  _model.salida = await actions.createInventory(
                                    _model.txtNameTextController.text,
                                    _model.comboCategoryValue!,
                                    _model.txtDescriptionTextController.text,
                                    int.parse(
                                        _model.txtAmountTextController.text),
                                    double.parse(
