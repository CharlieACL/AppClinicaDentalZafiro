                                ...
                                children: [
                                  Hero(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(8.0),
                                      child: Image.network(
                                        'https://www.smilecursos.com.br/wp-content/uploads/2017/12/post14.jpg',
                                        width: double.infinity,
                                        height: 400.0,
                                        fit: BoxFit.cover,
                                      ),
                          ...
                          child: Row(
                            ...
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.network(
                                  'https://i.pinimg.com/736x/bb/e3/95/bbe395c27077a804959b2c1f58f75889.jpg',
                                  width: 90.0,
                                  height: 90.0,
                                  fit: BoxFit.cover,
                                ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          'Explora los suministros disponibles.',
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                                fontFamily: 'Plus Jakarta Sans',
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            context.pushNamed('InventoryView');
                                          },
                                          child: const Icon(
                                            Icons.arrow_forward,
                          ...
                          child: Row(
                            ...
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.network(
                                  'https://th.bing.com/th/id/R.91cbcf069bf4cbe079bec4f126bd46f2?rik=I4OV7lenoOu42A&pid=ImgRaw&r=0',
                                  width: 90.0,
                                  height: 90.0,
                                  fit: BoxFit.cover,
                                ),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            context.pushNamed('odontologoView');
                                          },
                                          child: const Icon(
                                            Icons.arrow_forward,
                                            color: Color(0xFFEE8B60),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.network(
                                      'https://img.freepik.com/fotos-premium/dentista-trata-dientes-al-cliente-consultorio-dental_118454-23498.jpg',
                                      width: 90.0,
                                      height: 90.0,
                                      fit: BoxFit.cover,
                                    ),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              'Ingresa al historial de los clientes.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
                                                      .override(
