...
import 'cliente_create_model.dart';
export 'cliente_create_model.dart';

class ClienteCreateWidget extends StatefulWidget {
  const ClienteCreateWidget({super.key});

  @override
  State<ClienteCreateWidget> createState() => _ClienteCreateWidgetState();
}

class _ClienteCreateWidgetState extends State<ClienteCreateWidget> {
  late ClienteCreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClienteCreateModel());
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => setState(() {
          _model.txtRolTextController?.text = 'CLIENTE';
        }));
  }
                ...
                children: [
                  ...
                  Opacity(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        width: MediaQuery.sizeOf(context).width * 1.0,
                        height: MediaQuery.sizeOf(context).height * 0.782,
                        decoration: BoxDecoration(
                          color:
                              FlutterFlowTheme.of(context).secondaryBackground,
                          borderRadius: const BorderRadius.only(
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          labelText:
                                              'Digite la contraseña del cliente',
                                          labelStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelMedium
                                                  .override(
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          labelText:
                                              'Digite el teléfono del cliente',
                                          labelStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelMedium
                                                  .override(
                                    ...
                                    onPressed: () async {
                                      if ((_model.txtCorreoTextController.text == '') ||
                                        ...
                                        ScaffoldMessenger.of(context)
                                          ...
                                          SnackBar(
                                            content: const Text(
                                              'Hay campos vacíos por favor revise',
                                              style: TextStyle(
